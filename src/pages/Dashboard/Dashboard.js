          ...
          <div>
            <div className={`bg-gray-200  h-full p-4 rounded-md duration-300   relative ${open ? "lg:w-64" : "w-20"}`}>
              ...
              <ul className='  animate__animated animate__fadeInLeft'>
                ...
                {
                  (approve || admin || authorization) && <li className={`text-gray-300 text-md  flex items-start mt-2 rounded-md `}><Link to='/dashboard/requisitionAuthorize' className='w-full font-medium border-b border-gray-400  rounded-md    '>
                ...
                {
                  (store || admin) && <li className={`text-gray-300 text-md  flex items-start mt-2 rounded-md`}><Link to='/dashboard/requisitionIssue' className='w-full font-medium border-b border-gray-400  rounded-md    '>
                ...
                {
                  (admin || inventory) && <li className={`text-gray-300 text-md  flex items-start mt-2 rounded-md`}><Link to='/dashboard/addInventory' className='w-full font-medium border-b border-gray-400  rounded-md    '>
                ...
                {
                  (admin || inventory) && <li className={`text-gray-300 text-md flex items-start mt-2 rounded-md`}><Link to='/dashboard/currentStock' className='w-full font-medium border-b border-gray-400  rounded-md    '>
                ...
                {
                  (admin) && <li className={`text-gray-300 text-md  flex items-start mt-2 rounded-md`}><Link to='/dashboard/stockAdjust' className='w-full font-medium border-b border-gray-400  rounded-md    '>
                ...
                {
                  (inventory || admin) && <li className={`text-gray-300 text-md flex items-start mt-2 rounded-md`}><Link to='/dashboard/supplier' className='w-full font-medium border-b border-gray-400  rounded-md    '>
                ...
                {
                  (admin) && <li className={`text-gray-300 text-md  flex items-start mt-2 rounded-md`}><Link to='/dashboard/product' className='w-full font-medium border-b border-gray-400  rounded-md    '>
                ...
                {
                  (admin) && <li onClick={() => { setSubReportOpen(!subReportOpen); setOpenReports(!openReports) }} className={`text-gray-300 text-md  flex items-start rounded-md   mt-2   w-full font-medium border-b border-gray-400  `}>
                ...
                {
                  (admin) && <li className={`text-gray-300 text-md mt-2 flex items-start rounded-md`}><Link to='/dashboard/userManagement' className='w-full font-medium border-b border-gray-400  rounded-md    '>
                ...
                {/* ---------------------- All Users ---------------- */}
                {/* {
                  (admin) && <li className={`text-gray-300 text-md mt-2 flex items-start rounded-md`}><Link to='/dashboard/allUsers' className='w-full font-medium border-b border-gray-400  rounded-md    '>
                    <span className={` text-gray-700  block ml-1  ${!open ? "text-xl" : "ml-0"} `} >  <FaUsersCog /></span>
                ...
                {
                  (admin) && <li onClick={() => { setSubMenuOpen(!subMenuOpen); setOpenSettings(!openSettings) }} className={`text-gray-300 text-md  flex items-start rounded-md w-full mt-2 font-medium border-b border-gray-400   `}>
