            ...
            <div>
              <div className={`bg-gray-200  h-full p-5 rounded-md duration-300   relative ${open ? "w-69" : "w-20"}`}>
                ...
                <ul className='pt-8 animate__animated animate__fadeInLeft'>
                  ...
                  <li className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to='/dashboard/requisitionAuthorize' className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                  ...
                  <li className={` text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to='/dashboard/requisitionApproval' className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                  ...
                  <li className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to='/dashboard/requisitionIssue' className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                  ...
                  <li className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to='/dashboard/addInventory' className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                  ...
                  <li className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to='/dashboard/currentStock' className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                  ...
                  <li className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to='/dashboard/stockAdjust' className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                    <span className={`text-xl text-gray-800 hover:text-gray-700 block ml-1  ${!open ? "text-xl" : "ml-0"} `} >  <MdOutlineDashboardCustomize className='' /></span>
                  ...
                  <li className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to='/dashboard/supplier' className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                  ...
                  <li className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to='/dashboard/product' className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                  ...
                  <li onClick={() => setSubReportOpen(!subReportOpen)} className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400 `}>
                   ...
                   <span className={`text-xl text-gray-800 hover:text-gray-700 block ml-1  ${!open ? "text-xl" : "ml-0"} `} >  <HiDocumentReport className='' /></span>
                     ...
                     </li>
                    {
                      subReportOpen && <>
                       {/* ------------------------------ Product issue ----------------------- */}
                       <li className={`text-gray-300 text-md  flex items-start ml-4  hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to="/dashboard/reports/productIssue" className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                      ...
                      {/* ------------------------------ Inventory  ----------------------- */}
                      <li className={`text-gray-300 text-md  flex items-start ml-4  hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to="/dashboard/reports/inventory" className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                      ...
                      {/* ------------------------------ Employee User -------------------- */}
                      <li className={`text-gray-300 text-md  flex items-start ml-4  hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to="/dashboard/reports/employeeUser" className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                  ...
                  <li className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to='/dashboard/employee' className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                  ...
                  <li onClick={() => setSubMenuOpen(!subMenuOpen)} className={`text-gray-300 text-md  flex items-start   hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2   w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400 `}>
                    ...
                    </li>
                  {
                    subMenuOpen && <ul>
                      {/* ------------------------------ Setting Department ----------------------- */}
                      <li className={`text-gray-300 text-md  flex items-start ml-4  hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to="/dashboard/department" className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                      ...
                      {/* ------------------------------ Setting Designation ----------------------- */}
                      <li className={`text-gray-300 text-md  flex items-start ml-4  hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to="/dashboard/designation" className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                        <span className={`text-xl text-gray-800 hover:text-gray-700 block   ${!open ? "text-xl" : "ml-0"} `} >  <MdLocalLibrary className='' /></span>
                        <span className={` text-gray-800 ${!open && 'hidden'}`}>Designation </span></Link></li>
                      {/* ------------------------------ Setting Product Key ----------------------- */}
                      <li className={`text-gray-300 text-md  flex items-start ml-4  hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link to="/dashboard/productKey" className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                        <span className={`text-xl text-gray-800 hover:text-gray-700 block   ${!open ? "text-xl" : "ml-0"} `} >  <MdLocalLibrary className='' /></span>
                        <span className={` text-gray-800 ${!open && 'hidden'}`}>Product Key </span></Link></li>

                      {/* ------------------------ Setting Library ------------------- */}
                      <li onClick={() => setLibrarySubMenuOpen(!librarySubMenuOpen)} className={`text-gray-300 text-md  flex items-start ml-4  hover:bg-gray-400 hover:text-rose-300  text-xl  rounded-md mt-2  `}><Link className='w-full font-medium border-b border-gray-400  rounded-md  hover:bg-gray-400  '>
                        <span className={`text-xl text-gray-800 hover:text-gray-700 block   ${!open ? "text-xl" : "ml-0"} `} >  <MdLocalLibrary className='' /></span>
