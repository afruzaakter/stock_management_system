                ...
                <form onSubmit={handleSubmit(onSubmit)} >
                    <div className='lg:flex lg:gap-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input
                                ...
                                className={`input input-sm font-bold max-w-xs border border-green-800 focus:outline-0 rounded-sm  mt-1  lg:w-96  focus:border-blue-800  login-container-input ${errors.date && 'border-red-600 focus:border-red-600'}`}
                                {...register("date", {
                                    required: {
                                        value: true,
                        ...
                        <div className="form-control">
                            ...
                            <input
                                type="text"
                                placeholder='Notes'
                                className={`input input-sm font-bold max-w-xs border-green-700 focus:outline-0 rounded-sm  mt-1 w-96  focus:border-blue-500  login-container-input ${errors.notes && 'border-red-600 focus:border-red-600'}`}
                                {...register("notes", {
                                    required: {
                                        value: true,
                                        message: "❌  Please Fill-Up  Input Field"
                    ...
                    <div className='lg:flex lg:gap-3 '>
                        ...
                        <div className="form-control">
                            ...
                            })} className={`input input-sm  focus:outline-0 rounded-sm  border-green-700 mt-1  w-52 focus:border-blue-500  login-container-input ${errors.adjustReason && 'focus:border-red-600 border-red-600 focus:ring-red-600'} `}>
                        ...
                        <div className="form-control">
                            ...
                            })} className={`input input-sm  focus:outline-0 rounded-sm  border-green-700 mt-1  w-52 focus:border-blue-500  login-container-input ${errors.productName && 'focus:border-red-600 border-red-600 focus:ring-red-600'} `}>
                        ...
                        <div className="form-control">
                            ...
                            <input
                                type="text"
                                placeholder='1'
                                className={`input input-sm font-bold max-w-xs border-green-700 focus:outline-0 rounded-sm  mt-1 w-52  focus:border-blue-500  login-container-input ${errors.quantity && 'border-red-600 focus:border-red-600'}`}
                                {...register("quantity", {
                                    required: {
                                        value: true,
                                        message: "❌  Please Fill-Up  Input Field"
                     ...
                     <input
                                ...
                                placeholder='0'
                                value={totalAmount}
                                className={`input input-sm font-bold max-w-xs border-green-700 focus:outline-0 rounded-sm  mt-1 w-52  focus:border-blue-500  login-container-input `}
                    ...
                    <div className='lg:flex lg:gap-3'>
                        ...
                        <div className="form-control">
                            ...
                            <input
                                type="text"
                                placeholder='0'
                                className={`input input-sm font-bold max-w-xs border-green-700 focus:outline-0 rounded-sm  mt-1 w-96  focus:border-blue-500  login-container-input ${errors.price && 'border-red-600 focus:border-red-600'}`}
                                {...register("price", {
                                    required: {
                                        value: true,
                                        message: "❌  Please Fill-Up  Input Field"
                          ...
                          <div className="form-control">
                            ...
                            <input
                                ...
                                className={`input input-sm font-bold max-w-xs border-green-700 focus:outline-0 rounded-sm  mt-1 lg:w-96  focus:border-blue-500  login-container-input ${errors.itemsNotes && 'border-red-600 focus:border-red-600'}`}
                                {...register("itemsNotes", {
                                    required: {
                                        value: true,
                                        message: "❌  Please Fill-Up  Input Field"
                   ...
                   mx-1 bg-green-700 text-white w-28 rounded-sm  max-w-xs cursor-pointer font-bold uppercase hover:bg-primary hover:text-white ' type="submit" value='◲ Submit' />
